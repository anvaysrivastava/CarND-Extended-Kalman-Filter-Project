...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  if (!is_initialized_) {
    ...
    */
    // first measurement
    cout << "EKF1: " << endl;
    cout<<"sensor type . Actual:"<<measurement_pack.sensor_type_<<" radar: "<<MeasurementPackage::RADAR<<" Lidar:"<<MeasurementPackage::LASER<<endl;
    ekf_.x_ = VectorXd(4);
  ...
  float noise_ay = 9;
    ...
    cout<<"Present Time stamp: "<<measurement_pack.timestamp_<<" previous Time stamp "<<previous_timestamp_<<endl;
